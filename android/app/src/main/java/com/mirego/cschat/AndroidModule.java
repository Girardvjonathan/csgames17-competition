...
class AndroidModule {
    ...
    @Provides
    CreateConversationController provideCreateConversationController(CSChatService chatService, StorageService storageService) {
        return new CreateConversationController(chatService, storageService, application);
    }
